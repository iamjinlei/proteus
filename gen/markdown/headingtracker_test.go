	...
	cases := []struct {
		...
		},
		{
			...
			run: func(t *testing.T) {
				...
				ht.add(1, "h1", "heading1")
				ht.add(1, "h2", "heading2")
				ht.add(2, "h21", "heading2.1")
				ht.add(2, "h22", "heading2.2")
				ht.add(2, "h23", "heading2.3")
				ht.add(3, "h231", "heading2.3.1")
				ht.add(3, "h232", "heading2.3.2")
				ht.add(1, "h3", "heading3")
				ht.add(2, "h31", "heading3.1")
				ht.add(3, "h311", "heading3.1.1")
				ht.add(3, "h312", "heading3.1.2")
				ht.add(2, "h32", "heading3.2")
				ht.add(3, "h321", "heading3.2.1")
				ht.add(2, "h33", "heading3.3")
				...
				require.Equal(t, "h2", hds[1].Children[0].ParentID)
				...
				require.Equal(t, "h2", hds[1].Children[1].ParentID)
				...
				require.Equal(t, "h2", hds[1].Children[2].ParentID)
				...
				require.Equal(t, "h23", hds[1].Children[2].Children[0].ParentID)
				...
				require.Equal(t, "h23", hds[1].Children[2].Children[1].ParentID)
				...
				require.Equal(t, "h3", hds[2].Children[0].ParentID)
				...
				require.Equal(t, "h3", hds[2].Children[1].ParentID)
				...
				require.Equal(t, "h3", hds[2].Children[2].ParentID)
				...
				require.Equal(t, "h31", hds[2].Children[0].Children[0].ParentID)
				...
				require.Equal(t, "h31", hds[2].Children[0].Children[1].ParentID)
				...
				require.Equal(t, "h32", hds[2].Children[1].Children[0].ParentID)
		...
		},
		{
			...
			run: func(t *testing.T) {
				ht := newHeadingTracker()
				ht.add(3, "h211", "heading2.1.1")
				ht.add(3, "h212", "heading2.1.2")
				ht.add(4, "h2121", "heading2.1.2.1")
				...
				require.Equal(t, "h212", hds[1].Children[0].ParentID)
				require.Nil(t, hds[1].Children[0].Children)
			},
		},
		{
			...
			run: func(t *testing.T) {
				...
				require.Equal(t, "", hds[0].Children[0].ParentID)
				...
				require.Equal(t, "", hds[0].Children[1].ParentID)
				...
				require.Equal(t, "", hds[0].Children[2].ParentID)
				...
				require.Equal(t, "", hds[0].Children[0].Children[0].ParentID)
				...
				require.Equal(t, "", hds[0].Children[0].Children[1].ParentID)
